    allFunctions = function() {
        ...
        '<li class="content-cart"><a href="/conta/index"><i class="icon-shopping-cart fundo-principal"></i>Seu carrinho estÃ¡ vazio :(</a></li>' +
    ...
    vitrineTime = function() {
        ...
        if (t = this.getNavigableIndexes(), e = 0, i > t[t.length - 1]) i = t[t.length - 1];
            ...
            if (!0 === i.options.infinite)
                ...
                $(function() {
                    head(), addFavorito(), copyright(), allFunctions(), renameVitrine(), Rastreio(), newRodape(), vitrineTime(), vitrineResponsiva(), instagramRodape(), responsiveNew(), openMenu()
                });
